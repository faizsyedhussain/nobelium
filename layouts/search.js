  ...
  return (
    <Container>
      <div className="relative">
        ...
        <path fillRule="evenodd" clipRule="evenodd" d="M20.188 23.29C19.7974 23.681 19.1637 23.681 18.773 23.29L16.1218 20.636C15.8876 20.4016 15.7848 20.0664 15.8471 19.741L16.0214 18.8318C16.0627 18.6162 16.032 18.393 15.9339 18.1967L15.6594 17.6472C15.5421 17.4122 15.5881 17.1285 15.7737 16.9426V16.9426C15.9596 16.7565 16.2439 16.7104 16.4791 16.8281L16.9907 17.0842C17.209 17.1934 17.4597 17.2191 17.6955 17.1563L18.7098 16.8863C19.0547 16.7945 19.4223 16.8934 19.6745 17.1459L22.2941 19.7682C22.6841 20.1587 22.6841 20.7913 22.2941 21.1817L20.188 23.29Z" fill="text-black"/>
        </svg>
      </div>
      <Tags
        tags={tags}
