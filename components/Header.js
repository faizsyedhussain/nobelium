        ...
        {links.map(
          link =>
            link.show && (
              <li
                key={link.id}
                className="block ml-4 text-black dark:text-gray-500 nav"
              >
                <Link href={link.to}>
                  <a>{link.name}</a>
                </Link>
